...
public class ArticleService {
	...
	public Article findById(String id) {
		...
		if (article == null) {
			...
			//放入缓存
			stringRedisTemplate.opsForValue().set("article:" + id, JSON.toJSONString(article),10, TimeUnit.SECONDS);   //设置缓存的有效时间
		}
		return article;
	}
	...
	public void update(Article article) {
		stringRedisTemplate.delete("article:"+article.getId());
		articleDao.save(article);
	}
